...
def _callback(
    ...
    *,
    ...
    tokens = ve.tokenized()[:seq_len]
    tokens = jnp.pad(tokens, (0, seq_len - tokens.shape[0]))
...
class VertexEliminationEnv:
    ...
    def _token_shape(self):
        return (
            jax.ShapeDtypeStruct((self.seq_len,), jnp.int32),
    ...
    def step(self, state: EnvState, action: int | Array) -> EnvOut:
        ...
        sp_type = action // self.seq_len
        target_vertex = action % self.seq_len
